		...
		var t = {
				9698: function (t, e, n) {
					...
					class c extends r.BlockBlot {
						...
						formatAt(t, e, n, i) {
							e <= 0 ||
								(this.scroll.query(n, r.Scope.BLOCK) ? t + e === this.length() && this.format(n, i) : super.formatAt(t, Math.min(e, this.length() - t - 1), n, i),
								(this.cache = {}));
						}
						insertAt(t, e, n) {
					...
					function d(t) {
						...
						return null == t
							? e
							: ('formats' in t && 'function' == typeof t.formats && ((e = { ...e, ...t.formats() }), n && delete e['code-token']),
										...
										if ('string' == typeof r) {
											...
											this.query(i, u.Scope.INLINE)
												...
												: (n.length() && e.push({ type: 'block', delta: n, attributes: {} }),
													(n = new (d())()),
													e.push({ type: 'blockEmbed', key: i, value: r[i], attributes: t.attributes ?? {} }));
										}
								}),
								n.length() && e.push({ type: 'block', delta: n, attributes: {} }),
								e
								...
								this.quill.on(r.Ay.events.EDITOR_CHANGE, (t, e, n, i) => {
									t === r.Ay.events.SELECTION_CHANGE
										...
										: t === r.Ay.events.TEXT_CHANGE &&
											(this.ignoreChange || (this.options.userOnly && i !== r.Ay.sources.USER ? this.transform(e) : this.record(e, n)),
							...
							this.quill.keyboard.addBinding({
								...
								handler(t, e) {
									...
									return (
										...
										(this.quill.setSelection(t.index - 1, t.length + (i.shiftKey ? 1 : 0), r.Ay.sources.USER), !1)
									);
								},
							});
						}
				...
				6142: function (t, e, n) {
					...
					class I {
						...
						constructor(t) {
							...
							if (
								((this.options = (function (t, e) {
									...
									let u = M(e.modules);
									null != u && u.toolbar && u.toolbar.constructor !== Object && (u = { ...u, toolbar: { container: u.toolbar } });
						...
						setSelection(t, e, n) {
							null == t
								...
								: (([t, e, , n] = P(t, e, n)), this.selection.setRange(new f.Q(Math.max(0, t), e), n), n !== N.A.sources.SILENT && this.scrollSelectionIntoView());
						}
						setText(t) {
							let e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : N.A.sources.API;
					...
					function D(t, e, n, r) {
						...
						const s = this.editor.delta,
							l = t();
						if (
							(null != i && (!0 === n && (n = i.index), null == r ? (i = z(i, l, e)) : 0 !== r && (i = z(i, n, r, e)), this.setSelection(i, N.A.sources.SILENT)),
							l.length() > 0)
						) {
								...
								if (null != t) {
									...
									if (null == o || i || t !== o.startContainer || e !== o.startOffset || n !== o.endContainer || r !== o.endOffset) {
										t instanceof Element && 'BR' === t.tagName && ((e = Array.from(t.parentNode.childNodes).indexOf(t)), (t = t.parentNode)),
											n instanceof Element && 'BR' === n.tagName && ((r = Array.from(n.parentNode.childNodes).indexOf(n)), (n = n.parentNode));
										...
										i
											...
											.forEach(e => {
												...
												(null != i && ((l[i.attrName] = i.value(t)), l[i.attrName])) ||
													...
													(i = L[e]),
													null == i || (i.attrName !== e && i.keyName !== e) || ((i = L[e]), (l[i.attrName] = i.value(t) || void 0)));
											}),
						...
						return e.nodeType === e.TEXT_NODE
							...
							: e.nodeType === e.ELEMENT_NODE
								? Array.from(e.childNodes || []).reduce((s, o) => {
										let l = I(t, o, n, r, i);
										return (
											o.nodeType === e.ELEMENT_NODE && ((l = n.reduce((e, n) => n(o, e, t), l)), (l = (i.get(o) || []).reduce((e, n) => n(o, e, t), l))),
											s.concat(l)
										);
									}, new (s())())
								: new (s())();
					...
					class f extends u.A {
								...
								e.some(t => {
									...
									if (Array.isArray(t.format)) {
										...
										!Object.keys(t.format).every(e =>
											!0 === t.format[e] ? null != m.format[e] : !1 === t.format[e] ? null == m.format[e] : (0, r.A)(t.format[e], m.format[e])
										)
									)
										return !1;
									return !(
						...
						handleEnter(t, e) {
							const n = Object.keys(e.format).reduce(
									(t, n) => (this.quill.scroll.query(n, l.Scope.BLOCK) && !Array.isArray(e.format[n]) && (t[n] = e.format[n]), t),
									{}
								),
						...
						bindings: {
							...
							tab: {
								...
								handler(t, e) {
									...
									return (
										this.quill.updateContents(n, a.Ay.sources.USER), this.quill.history.cutoff(), this.quill.setSelection(t.index + 1, a.Ay.sources.SILENT), !1
									);
								},
							},
							...
							'list autofill': {
								...
								handler(t, e) {
									...
									const l = new (o())()
										...
										.retain(1, { list: s });
									return (
										this.quill.updateContents(l, a.Ay.sources.USER), this.quill.history.cutoff(), this.quill.setSelection(t.index - n, a.Ay.sources.SILENT), !1
									);
								},
							},
							'code exit': {
						...
						return {
							...
							handler(e, n) {
								...
								if (0 === e.length && !r.shiftKey)
									return this.quill.insertText(e.index, s, a.Ay.sources.USER), void this.quill.setSelection(e.index + s.length, a.Ay.sources.SILENT);
								...
								o.forEach((e, n) => {
									t
										...
										: e.domNode.textContent.startsWith(s) && (e.deleteAt(0, s.length), 0 === n ? (l -= s.length) : (c -= s.length));
								}),
						...
						return {
							...
							handler(e, n) {
								...
								if (null != s) {
									...
									null != e &&
										(t
											? this.quill.setSelection(e.offset(this.quill.scroll) + e.length() - 1, 0, a.Ay.sources.USER)
				...
				5090: function (t) {
								...
								var f = (function (t, e) {
									...
									return d || f
										? ((s = f ? (d && d[4].length > f[4].length ? d : f) : d),
											t.length > e.length ? ((l = s[0]), (c = s[1]), (u = s[2]), (h = s[3])) : ((u = s[0]), (h = s[1]), (l = s[2]), (c = s[3])),
											[l, c, u, h, s[4]])
										: null;
								})(t, l);
								if (f) {
								...
								return (function (t, r) {
									...
									for (var f = i - o, p = f % 2 != 0, g = 0, m = 0, b = 0, y = 0, v = 0; v < l; v++) {
										for (var A = -v + g; A <= v - m; A += 2) {
											for (
												var x = a + A, N = (_ = A === -v || (A !== v && u[x - 1] < u[x + 1]) ? u[x + 1] : u[x - 1] + 1) - A;
										...
										for (var E = -v + b; E <= v - y; E += 2) {
											for (
												var w, q = a + E, k = (w = E === -v || (E !== v && h[q - 1] < h[q + 1]) ? h[q + 1] : h[q - 1] + 1) - E;
											...
											(function (t) {
												...
												for (var n = 1; n < t.length - 1; ) {
													if (t[n - 1][0] == r && t[n + 1][0] == r) {
														...
														t[n - 1][1] != g &&
															(g ? (t[n - 1][1] = g) : (t.splice(n - 1, 1), n--), (t[n][1] = m), b ? (t[n + 1][1] = b) : (t.splice(n + 1, 1), n--));
													}
													n++;
												}
											})(t),
										...
										if (t[m - 1][0] == e && t[m][0] == n) {
											...
											E >= w
												? (E >= x.length / 2 || E >= N.length / 2) &&
													(t.splice(m, 0, [r, N.substring(0, E)]), (t[m - 1][1] = x.substring(0, x.length - E)), (t[m + 1][1] = N.substring(E)), m++)
					...
					function a(t, e) {
						...
						for (var n = 0, r = Math.min(t.length, e.length), i = r, s = 0; n < i; )
							t.substring(t.length - i, t.length - s) == e.substring(e.length - i, e.length - s) ? (s = n = i) : (r = i), (i = Math.floor((r - n) / 2 + n));
										...
										if (h.length > 0 || d.length > 0) {
											h.length > 0 &&
												...
												(0 !== (s = o(d, h)) &&
													...
													(h = h.substring(s))),
												0 !== (s = a(d, h)) &&
													((t[l][1] = d.substring(d.length - s) + t[l][1]), (d = d.substring(0, d.length - s)), (h = h.substring(0, h.length - s))));
											var v = u + c;
							...
							t[l - 1][0] === r &&
								...
								(t[l][1].substring(t[l][1].length - t[l - 1][1].length) === t[l - 1][1]
									...
									: t[l][1].substring(0, t[l + 1][1].length) == t[l + 1][1] &&
										((t[l - 1][1] += t[l + 1][1]), (t[l][1] = t[l][1].substring(t[l + 1][1].length) + t[l + 1][1]), t.splice(l + 1, 1), (A = !0))),
								l++;
						A && p(t, i);
					}
					function g(t) {
								...
								(function (t, e, n, r, i, s) {
									...
									if (f && !p) {
										...
										A == x ||
											!('constructor' in t) ||
											!('constructor' in e) ||
											('function' == typeof A && A instanceof A && 'function' == typeof x && x instanceof x) ||
											(f = !1);
									}
									...
									: t instanceof Text || t.nodeType === Node.TEXT_NODE
										...
										: 'number' == typeof t
											...
											: t instanceof Element &&
												((t.getAttribute('class') || '').split(/\s+/).some(t => ((n = this.classes[t]), !!n)), (n = n || this.tags[t.tagName])),
							...
							this.children.forEach(n => {
								e ||
									...
									(n.statics.scope === r.BLOCK_BLOT
										? (null != n.next && this.splitAfter(n), null != n.prev && this.splitAfter(n.prev), n.parent.unwrap(), (e = !0))
										: n instanceof t
											? n.unwrap()
											: n.remove());
							});
						...
						T = class t extends m {
							...
							optimize(e) {
								super.optimize(e),
									...
									0 === this.text.length
										? this.remove()
										: this.next instanceof t && this.next.prev === this && (this.insertAt(this.length(), this.next.value()), this.next.remove());
							}
							position(t, e = !1) {
						...
						(this.pickers = Array.from(t).map(t => {
							...
							return (
								null == t.querySelector('option') &&
									(t.classList.contains('ql-font') ? kt(t, xt) : t.classList.contains('ql-header') ? kt(t, Nt) : t.classList.contains('ql-size') && kt(t, Et)),
								new dt(t)
							);
						})),
					...
					save() {
						...
						switch (this.root.getAttribute('data-mode')) {
							case 'link': {
								...
								this.linkRange
									? (this.quill.formatText(this.linkRange, 'link', t, bt.A.sources.USER), delete this.linkRange)
