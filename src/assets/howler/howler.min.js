...
!(function () {
		...
		_autoSuspend: function () {
			...
			if (e.autoSuspend && e.ctx && void 0 !== e.ctx.suspend && n.usingWebAudio) {
				for (var o = 0; o < e._howls.length; o++)
					if (e._howls[o]._webAudio) for (var t = 0; t < e._howls[o]._sounds.length; t++) if (!e._howls[o]._sounds[t]._paused) return e;
				return (
	...
	o.prototype = {
					...
					a._node &&
						(o._webAudio
							...
							: (isNaN(a._node.duration) && a._node.duration !== 1 / 0) ||
								((a._node.currentTime = a._start || 0), a._node.pause(), a._node.duration === 1 / 0 && o._clearSound(a._node))),
			...
			(e._fadeTo = o),
				(e._interval = setInterval(function () {
					...
					(l = Date.now()),
						...
						a && (u._volume = d),
						((o < n && d <= o) || (o > n && d >= o)) &&
							(clearInterval(e._interval), (e._interval = null), (e._fadeTo = null), u.volume(o, e._id), u._emit('fade', e._id));
				}, s));
		},
		...
		_ended: function (e) {
			...
			return (
				o._webAudio &&
					!r &&
					((e._paused = !0), (e._ended = !0), (e._seek = e._start || 0), (e._rateSeek = 0), o._clearTimer(e._id), o._cleanBuffer(e._node), n._autoSuspend()),
	...
	t.prototype = {
		...
		_endListener: function () {
			var e = this,
				n = e._parent;
			n._duration === 1 / 0 &&
				((n._duration = Math.ceil(10 * e._node.duration) / 10), n._sprite.__default[1] === 1 / 0 && (n._sprite.__default[1] = 1e3 * n._duration), n._ended(e)),
	...
	'function' == typeof define &&
		...
		'undefined' != typeof global
			...
			: 'undefined' != typeof window && ((window.HowlerGlobal = e), (window.Howler = n), (window.Howl = o), (window.Sound = t));
})();
/*! Spatial Plugin */
!(function () {
	'use strict';
