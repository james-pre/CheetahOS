!(function (t, i) {
	'object' == typeof exports && 'undefined' != typeof module
		...
		: 'function' == typeof define && define.amd
			? define(i)
			: ((t = 'undefined' != typeof globalThis ? globalThis : t || self).SiriWave = i());
})(this, function () {
	'use strict';
	/*! *****************************************************************************
    ...
    ***************************************************************************** */ var t = function () {
	...
	var i = (function () {
			function t(t, i) {
				(this.ATT_FACTOR = 4), (this.GRAPH_X = 2), (this.AMPLITUDE_FACTOR = 0.6), (this.ctrl = t), (this.definition = i);
			}
			return (
		...
		s = (function () {
			...
			return (
				...
				(t.prototype.spawnSingle = function (t) {
					var i, s, e, o, n, h, r, a, p, l;
					(this.phases[t] = 0),
						(this.amplitudes[t] = 0),
						(this.despawnTimeouts[t] = this.getRandomRange(
							null !== (s = null === (i = this.ctrl.opt.ranges) || void 0 === i ? void 0 : i.despawnTimeout) && void 0 !== s ? s : this.DEFAULT_DESPAWN_TIMEOUT_RANGES
						)),
						(this.offsets[t] = this.getRandomRange(
							null !== (o = null === (e = this.ctrl.opt.ranges) || void 0 === e ? void 0 : e.offset) && void 0 !== o ? o : this.DEFAULT_OFFSET_RANGES
						)),
						(this.speeds[t] = this.getRandomRange(
							null !== (h = null === (n = this.ctrl.opt.ranges) || void 0 === n ? void 0 : n.speed) && void 0 !== h ? h : this.DEFAULT_SPEED_RANGES
						)),
						(this.finalAmplitudes[t] = this.getRandomRange(
							null !== (a = null === (r = this.ctrl.opt.ranges) || void 0 === r ? void 0 : r.amplitude) && void 0 !== a ? a : this.DEFAULT_AMPLITUDE_RANGES
						)),
						(this.widths[t] = this.getRandomRange(
							null !== (l = null === (p = this.ctrl.opt.ranges) || void 0 === p ? void 0 : p.width) && void 0 !== l ? l : this.DEFAULT_WIDTH_RANGES
						)),
				...
				(t.prototype.spawn = function () {
					...
					(this.spawnAt = Date.now()),
						(this.noOfCurves = Math.floor(
							this.getRandomRange(
								null !== (i = null === (t = this.ctrl.opt.ranges) || void 0 === t ? void 0 : t.noOfCurves) && void 0 !== i ? i : this.DEFAULT_NOOFCURVES_RANGES
							)
						)),
					...
					for (var s = 0; s < this.noOfCurves; s++) this.spawnSingle(s);
				}),
				(t.prototype.globalAttFn = function (t) {
				...
				(t.prototype.draw = function () {
					...
					if (
						((t.globalAlpha = 0.7),
						(t.globalCompositeOperation = this.ctrl.opt.globalCompositeOperation),
						0 === this.spawnAt && this.spawn(),
						this.definition.supportLine)
					)
						return this.drawSupportLine();
					for (var i = 0; i < this.noOfCurves; i++)
						this.spawnAt + this.despawnTimeouts[i] <= Date.now() ? (this.amplitudes[i] -= this.DESPAWN_FACTOR) : (this.amplitudes[i] += this.DESPAWN_FACTOR),
							(this.amplitudes[i] = Math.min(Math.max(this.amplitudes[i], 0), this.finalAmplitudes[i])),
							(this.phases[i] = (this.phases[i] + this.ctrl.speed * this.speeds[i] * this.SPEED_FACTOR) % (2 * Math.PI));
		...
		function e(e) {
				...
				h = (function (t, i) {
					...
					if (null != t && 'function' == typeof Object.getOwnPropertySymbols) {
						...
						for (e = Object.getOwnPropertySymbols(t); o < e.length; o++)
							i.indexOf(e[o]) < 0 && Object.prototype.propertyIsEnumerable.call(t, e[o]) && (s[e[o]] = t[e[o]]);
					}
					return s;
				})(e, ['container']);
			...
			if (
				...
				!0 === this.opt.cover
					...
					: ((this.canvas.style.width = ''.concat(this.width / this.opt.ratio, 'px')), (this.canvas.style.height = ''.concat(this.height / this.opt.ratio, 'px'))),
				'ios9' === this.opt.style)
			)
				...
				this.curves = (this.opt.curveDefinition || i.getDefinition()).map(function (t) {
					return new i(o, t);
				});
