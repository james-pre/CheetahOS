	...
	return (function (t) {
					...
					try {
						...
						return (
							...
							void (
								...
								(console.log('[VANTA] Falling back to backgroundColor'), (this.el.style.background = Object(s.b)(this.options.backgroundColor)))
							)
						);
					}
		...
		17: function (t, e, i) {
			...
			class r extends s.b {
				...
				getMaterial() {
					const t = { color: this.options.color, shininess: this.options.shininess, flatShading: !0, vertexColors: n.FaceColors, side: n.DoubleSide };
					...
					for (t = 1; t <= this.ww; t++)
						for (e = 1; e <= this.hh; e++) {
							...
							const h = this.gg[t][e],
								...
								c = this.gg[t - 1][e],
								l = this.gg[t - 1][e - 1];
							Object(o.g)(0, 1) ? ((i = new n.Face3(l, a, c)), (r = new n.Face3(a, c, h))) : ((i = new n.Face3(l, a, h)), (r = new n.Face3(l, c, h))),
								s.faces.push(i, r);
						}
