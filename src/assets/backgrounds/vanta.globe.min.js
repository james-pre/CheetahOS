				...
				try {
					...
					return (
						...
						void (
							...
							(this.el.style.background = ((i = this.options.backgroundColor), 'number' == typeof i ? '#' + ('00000' + i.toString(16)).slice(-6) : i)))
						)
					);
				}
			...
			onUpdate() {
				...
				for (let t = 0; t < this.points.length; t++) {
					...
					(l.scale.z = (0.25 * (15 - c)).clamp(1, 100)),
						...
						(l.position.y = 2 * Math.sin(l.position.x / 10 + 0.01 * this.t + (l.position.z / 10) * 0.5));
