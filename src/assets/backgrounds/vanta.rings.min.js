!(function (t, e) {
	...
	(() => {
		...
		l.VantaBase = class {
				...
				try {
					...
					return (
						...
						void (
							...
							(this.el.style.background = ((s = this.options.backgroundColor), 'number' == typeof s ? '#' + ('00000' + s.toString(16)).slice(-6) : s)))
						)
					);
				}
			...
			initThree() {
				a.WebGLRenderer
					? ((this.renderer = new a.WebGLRenderer({ alpha: !0, antialias: !0 })),
		...
		class u extends p {
			static initClass() {
				(this.prototype.defaultOptions = { backgroundColor: 2106408, color: 8978176 }),
			...
			genRing(t, e, i, r, h, a, l) {
				...
				const c = { depth: 0.4, bevelEnabled: !1, steps: 1, curveSegments: ~~((64 * h) / 6.14) },
					p = new d.Shape();
				p.absarc(0, 0, e + i, 0, h, !1), p.lineTo(e * Math.cos(h), e * Math.sin(h)), p.absarc(0, 0, e, h, 0, !0);
				const u = new d.ExtrudeGeometry(p, c),
					m = this.material(t);
				(0 === n(0, 1) || e > 60) && ((m.transparent = !0), (m.opacity = Math.max(50 / e + o(-0.3, 0.3), 0.1)));
				...
				if (
					...
					try {
						this.genRing(s(this.colors), e + o(-1, 3), i + o(-2, 0), r + h, h + o(-0.5, 0.5), a + o(-3, 1), l);
					} catch (t) {}
				return f;
			}
			onInit() {
				...
				for (let e = 0; e < r; e++) {
					let e;
					n(0, 3)
						? ((e = o(2, 4) + o(1, 30) * o(1, 2) * o(1, 2) * o(1, 2)), i() && (e *= 0.5), (t = o(0, 3.5) + o(0, 3.5) - n(0, e / 4) - e / 50))
						: ((e = o(1, 3) * o(2, 4)), (t = o(1, 2) * o(1, 2) * o(1.1, 1.5)));
					const r = 0.05 * Math.pow(2, n(0, 4));
					t < r && (t = r),
						this.genRing(s(this.colors), e, t, o(0, 1e3), o(1, 6), o(0, 50 / (e + 1) + 5) + 5 / t / (e + 0.5), 0.25 * Math.max(-o(0.5, 2), o(1, 50 - e / 2) - e / 2));
				}
			...
			onMouseMove(t, e) {
				const i = this.camera;
				return i.oy || ((i.oy = i.position.y), (i.ox = i.position.x)), (i.tx = i.ox + 50 * (t - 0.5)), (i.ty = i.oy - 50 * e);
			}
		}
		u.initClass();
