...
export class AppComponent implements OnDestroy, AfterViewInit {
	...
	constructor(
		...
		this._startProcessSub = this._triggerProcessService.startProcessNotify.subscribe(appName => {
			this.loadApps(appName);
		});
		this._appNotFoundSub = this._triggerProcessService.appNotFoundNotify.subscribe(appName => {
			this.showDialogMsgBox(NotificationType.Error, appName);
		});
		this._appIsRunningSub = this._triggerProcessService.appIsRunningNotify.subscribe(appName => {
